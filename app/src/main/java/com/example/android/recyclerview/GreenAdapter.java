...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    public interface ListItemClickListener {
        void onListItemClick(int clickItemIndex, View itemView);
...
//        viewHolder.itemView.setBackgroundColor(backgroundColorForViewHolder);
    ...
    public void onBindViewHolder(NumberViewHolder holder, int position) {
        ...
        if(position % 2 == 0) // 2 different colors for odd and even row
            holder.itemView.setBackgroundColor(Color.parseColor("#FFB900"));
        else
            holder.itemView.setBackgroundColor(Color.parseColor("#0087C3"));
    }
    ...
    class NumberViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            mOnClickListener.onListItemClick(clickedPosition, view); // pass selected list as view variable
        }
